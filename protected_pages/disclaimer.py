...
def app():
    ...
    - Some of the information are AI/LLM-assisted and AI/LLM-generated, and may be inaccurate. 
    ...
    """)
    st.info("Note: Information provided here is NOT ready to be relied upon for making any decisions, especially those related to financial, legal, construction-related matters, or any other actual real-life applications.")
