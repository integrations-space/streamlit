...
<ul>
<li>DeepSeek-AI (2024) 'DeepSeek-V3 Technical Report'. Available at: <a href="https://arxiv.org/abs/2412.19437" style="color:#4FC3F7;">arxiv.org/abs/2412.19437</a> — large open-weight MoE (671B total / 37B active).</li>
<li>DeepSeek-AI 'DeepSeek-V3 GitHub repository'. Available at: <a href="https://github.com/deepseek-ai/DeepSeek-V3" style="color:#4FC3F7;">github.com/deepseek-ai/DeepSeek-V3</a> — model weights, inference code, and deployment guidance.</li>
<li>Meta AI (2025) 'The Llama 4 herd: The beginning of a new era of natively multimodal AI innovation' (5 April 2025). Available at: <a href="https://ai.meta.com/blog/llama-4-multimodal-intelligence/" style="color:#4FC3F7;">ai.meta.com/blog/llama-4-multimodal-intelligence/</a> — Llama 4 Scout (17B active / 109B total, 16 experts, 10M context) and Maverick (17B active / 400B total, 128 experts); both MoE, the vision picks used via Groq in this PoC.</li>
<li>Mistral AI (2024) 'Announcing Pixtral 12B'. Available at: <a href="https://mistral.ai/news/pixtral-12b" style="color:#4FC3F7;">mistral.ai/news/pixtral-12b</a> — Mistral's first multimodal model, Apache 2.0 licensed.</li>
<li>Mistral AI (2024) 'Pixtral Large' <em>(marked deprecated by Mistral as of late 2025)</em>. Available at: <a href="https://mistral.ai/news/pixtral-large" style="color:#4FC3F7;">mistral.ai/news/pixtral-large</a> — 124B open-weight multimodal model built on Mistral Large 2.</li>
<li>Google (2025) 'Gemini 2.5: Our most intelligent AI model' (March 2025). Available at: <a href="https://blog.google/technology/google-deepmind/gemini-model-thinking-updates-march-2025/" style="color:#4FC3F7;">blog.google/technology/google-deepmind/gemini-model-thinking-updates-march-2025/</a> — announcement of Gemini 2.5 Pro Experimental; 2.5 Flash is available alongside it via the Google AI Studio link below.</li>
